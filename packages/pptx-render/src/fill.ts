 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@airy-office/pptx-engine'
...
export function resolveGlow(
  glow: import('@airy-office/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@airy-office/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
