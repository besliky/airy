...
/**
 * Lazy accessibility policy (PERF-1700c): support must stay off until
 * Chromium's own assistive-tech detection turns it on, and only the explicit
 * AIRY_FORCE_A11Y=1 escape hatch may force it.
 */

describe('applyAccessibilityPolicy', () => {
