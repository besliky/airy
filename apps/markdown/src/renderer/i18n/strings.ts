export const strings = {
  zh: {
    ...
    replace: '替换',
    replaceAll: '全部替换',
    findOverflow: '还有 {n} 处匹配未高亮',
    replaceRemaining: '正在替换，还剩 {n} 处…',
    findTip: '查找和替换 (⌘F)',
  ...
  en: {
    ...
    findOverflow: '+{n} more matches not highlighted',
    replaceRemaining: 'Replacing… {n} left',
  ...
  ja: {
    ...
    replace: '置換',
    replaceAll: 'すべて置換',
    findOverflow: '他 {n} 件の一致は未ハイライト',
    replaceRemaining: '置換中… 残り {n} 件',
    findTip: '検索と置換 (⌘F)',
  ...
  ko: {
    ...
    replace: '바꾸기',
    replaceAll: '모두 바꾸기',
    findOverflow: '{n}개 더 찾았음(하이라이트 안 됨)',
    replaceRemaining: '바꾸는 중… {n}개 남음',
    findTip: '찾기 및 바꾸기 (⌘F)',
  ...
  fr: {
    ...
    findOverflow: '+{n} correspondances non surlignées',
    replaceRemaining: 'Remplacement… {n} restants',
  ...
  de: {
    ...
    encodingAuto: 'Automatisch erkennen',
    reopenEncoding: 'Mit Kodierung neu öffnen',
    openedAs: 'Geöffnet als {encoding}',
    openedAuto: 'Mit automatisch erkannter Kodierung neu geöffnet',
    reopenDirty:
      'Speichern oder verwerfen Sie Ihre Änderungen, bevor Sie mit einer anderen Kodierung neu öffnen',
    ...
    findOverflow: '+{n} weitere Treffer nicht hervorgehoben',
    replaceRemaining: 'Ersetzen… {n} verbleibend',
  ...
  es: {
    ...
    findOverflow: '+{n} coincidencias sin resaltar',
    replaceRemaining: 'Reemplazando… faltan {n}',
  ...
  th: {
    ...
    findOverflow: 'ยังมีอีก {n} รายการที่ไม่ได้ไฮไลต์',
    replaceRemaining: 'กำลังแทนที่… เหลือ {n} รายการ',
  ...
  id: {
    ...
    findOverflow: '+{n} kecocokan lain tidak disorot',
    replaceRemaining: 'Mengganti… {n} tersisa',
  ...
  ru: {
    ...
    findOverflow: 'ещё {n} совпадений не подсвечено',
    replaceRemaining: 'Замена… осталось {n}',
  ...
  ar: {
    ...
    findOverflow: '+{n} مطابقة أخرى غير مميزة',
    replaceRemaining: 'جارٍ الاستبدال… بقي {n}',
  ...
  pt: {
    ...
    reopenEncoding: 'Reabrir com codificação',
    openedAs: 'Aberto como {encoding}',
    openedAuto: 'Reaberto com a codificação detectada automaticamente',
    reopenDirty: 'Salve ou desfaça suas alterações antes de reabrir com outra codificação',
    saving: 'Salvando…',
    savedOk: 'Salvo',
    ...
    findOverflow: '+{n} ocorrências não realçadas',
    replaceRemaining: 'Substituindo… faltam {n}',
  ...
  it: {
    ...
    findOverflow: '+{n} corrispondenze non evidenziate',
    replaceRemaining: 'Sostituzione… ne restano {n}',
  ...
  pl: {
    ...
    findOverflow: 'jeszcze {n} dopasowań niewyróżnionych',
    replaceRemaining: 'Zamienianie… pozostało {n}',
  ...
  cs: {
    ...
    findOverflow: 'dalších {n} výskytů nezvýrazněno',
    replaceRemaining: 'Nahrazování… zbývá {n}',
  ...
  nl: {
    ...
    findOverflow: 'nog {n} overeenkomsten niet gemarkeerd',
    replaceRemaining: 'Vervangen… {n} resterend',
  ...
  ms: {
    ...
    reopenDirty:
      'Simpan atau batalkan perubahan anda sebelum membuka semula dengan pengekodan lain',
    saving: 'Menyimpan…',
    savedOk: 'Disimpan',
    saveFailed: 'Gagal menyimpan',
    ...
    replace: 'Ganti',
    replaceAll: 'Ganti Semua',
    findOverflow: '+{n} padanan lain tidak diserlahkan',
    replaceRemaining: 'Mengganti… {n} lagi',
  ...
  he: {
    ...
    findOverflow: '+{n} התאמות נוספות לא סומנו',
    replaceRemaining: 'מחליף… נותרו {n}',
  ...
  hi: {
    ...
    findOverflow: '+{n} और मिलान हाइलाइट नहीं किए गए',
    replaceRemaining: 'बदल रहा है… {n} शेष',
  ...
  'zh-TW': {
    ...
    replace: '取代',
    replaceAll: '全部取代',
    findOverflow: '還有 {n} 處匹配未高亮',
    replaceRemaining: '正在取代，還剩 {n} 處…',
    findTip: '尋找與取代 (⌘F)',
