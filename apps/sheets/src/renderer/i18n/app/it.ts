...
export const it = {
  ...
  appPrintPreviewFailed: 'Impossibile generare l’anteprima di stampa.',
  appPrintTooLarge:
  ...
  appThreadNewComment: 'Nuovo commento',
  appThreadNewCommentDetail: 'Avvia un thread di commenti',
  appThreadComments: 'Commenti',
  appThreadShowCommentsDetail: 'Apri il riquadro commenti',
  appThreadEmpty: 'Nessun commento in questo foglio.',
  appThreadResolve: 'Risolto',
  appThreadReopen: 'Riapri',
  appThreadGoToCell: 'Vai alla cella',
  appThreadReplyPlaceholder: 'Rispondi…',
  appThreadNewPlaceholder: 'Aggiungi un commento alla cella selezionata…',
  appThreadPost: 'Pubblica',
  appThreadUnknownAuthor: 'Sconosciuto',
  appNewNote: 'Nuova nota',
  ...
  scGroupFile: 'File',
  scGroupWorkbook: 'Cartella di lavoro',
  scGroupSelection: 'Selezione',
  scOpen: 'Apri…',
  scSave: 'Salva',
  ...
  scUndo: 'Annulla',
  scRedo: 'Ripeti',
  scNextSheet: 'Foglio successivo',
  scPrevSheet: 'Foglio precedente',
  scFirstCell: 'Prima cella (A1)',
  scLastUsedCell: 'Ultima cella usata',
  scRowStart: 'Inizio riga',
  scSelectColumn: 'Seleziona colonna',
  scSelectRow: 'Seleziona riga',
  scHideRows: 'Nascondi righe',
