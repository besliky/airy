...
export const de = {
  ...
  appPrintPreviewFailed: 'Die Druckvorschau konnte nicht erstellt werden.',
  appPrintTooLarge:
  ...
  appThreadNewComment: 'Neuer Kommentar',
  appThreadNewCommentDetail: 'Einen Kommentarthread beginnen',
  appThreadComments: 'Kommentare',
  appThreadShowCommentsDetail: 'Kommentarbereich öffnen',
  appThreadEmpty: 'Auf diesem Blatt gibt es noch keine Kommentare.',
  appThreadResolve: 'Gelöst',
  appThreadReopen: 'Wieder öffnen',
  appThreadGoToCell: 'Zur Zelle wechseln',
  appThreadReplyPlaceholder: 'Antworten …',
  appThreadNewPlaceholder: 'Ausgewählte Zelle kommentieren …',
  appThreadPost: 'Veröffentlichen',
  appThreadUnknownAuthor: 'Unbekannt',
  appNewNote: 'Neue Notiz',
  ...
  scGroupFile: 'Datei',
  scGroupWorkbook: 'Arbeitsmappe',
  scGroupSelection: 'Auswahl',
  scOpen: 'Öffnen…',
  scSave: 'Speichern',
  ...
  scUndo: 'Rückgängig',
  scRedo: 'Wiederholen',
  scNextSheet: 'Nächstes Blatt',
  scPrevSheet: 'Vorheriges Blatt',
  scFirstCell: 'Erste Zelle (A1)',
  scLastUsedCell: 'Letzte verwendete Zelle',
  scRowStart: 'Zeilenanfang',
  scSelectColumn: 'Spalte markieren',
  scSelectRow: 'Zeile markieren',
  scHideRows: 'Zeilen ausblenden',
  ...
  appTextToColsTooManyRows:
    'Text in Spalten unterstützt bis zu {count} Zeilen — die Auswahl umfasst {rows}. Wähle einen kleineren Bereich.',
