...
export const ja = {
  ...
  appThreadNewComment: '新しいコメント',
  appThreadNewCommentDetail: 'スレッド コメントを開始',
  appThreadComments: 'コメント',
  appThreadShowCommentsDetail: 'コメント ウィンドウを開く',
  appThreadEmpty: 'このシートにはまだコメントがありません。',
  appThreadResolve: '解決済み',
  appThreadReopen: '再び開く',
  appThreadGoToCell: 'セルへ移動',
  appThreadReplyPlaceholder: '返信…',
  appThreadNewPlaceholder: '選択したセルにコメント…',
  appThreadPost: '投稿',
