...
export const fr = {
  ...
  appPrintPreviewFailed: 'Impossible de générer l’aperçu d’impression.',
  appPrintTooLarge:
  ...
  appThreadNewComment: 'Nouveau commentaire',
  appThreadNewCommentDetail: 'Démarrer un fil de commentaires',
  appThreadComments: 'Commentaires',
  appThreadShowCommentsDetail: 'Ouvrir le volet Commentaires',
  appThreadEmpty: 'Aucun commentaire sur cette feuille pour le moment.',
  appThreadResolve: 'Résolu',
  appThreadReopen: 'Rouvrir',
  appThreadGoToCell: 'Aller à la cellule',
  appThreadReplyPlaceholder: 'Répondre…',
  appThreadNewPlaceholder: 'Commenter la cellule sélectionnée…',
  appThreadPost: 'Publier',
  appThreadUnknownAuthor: 'Inconnu',
  appNewNote: 'Nouvelle note',
  ...
  scGroupFile: 'Fichier',
  scGroupWorkbook: 'Classeur',
  scGroupSelection: 'Sélection',
  scOpen: 'Ouvrir…',
  scSave: 'Enregistrer',
  ...
  scUndo: 'Annuler',
  scRedo: 'Rétablir',
  scNextSheet: 'Feuille suivante',
  scPrevSheet: 'Feuille précédente',
  scFirstCell: 'Première cellule (A1)',
  scLastUsedCell: 'Dernière cellule utilisée',
  scRowStart: 'Début de ligne',
  scSelectColumn: 'Sélectionner la colonne',
  scSelectRow: 'Sélectionner la ligne',
  scHideRows: 'Masquer les lignes',
