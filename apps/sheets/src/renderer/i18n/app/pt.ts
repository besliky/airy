...
export const pt = {
  ...
  appPrintFailed: 'Falha ao imprimir: {error}',
  appPrintPreviewFailed: 'Não foi possível gerar a visualização de impressão.',
  appPrintTooLarge:
  ...
  appThreadNewComment: 'Novo comentário',
  appThreadNewCommentDetail: 'Iniciar um thread de comentários',
  appThreadComments: 'Comentários',
  appThreadShowCommentsDetail: 'Abrir o painel de comentários',
  appThreadEmpty: 'Ainda não há comentários nesta planilha.',
  appThreadResolve: 'Resolvido',
  appThreadReopen: 'Reabrir',
  appThreadGoToCell: 'Ir para a célula',
  appThreadReplyPlaceholder: 'Responder…',
  appThreadNewPlaceholder: 'Comentar a célula selecionada…',
  appThreadPost: 'Publicar',
  appThreadUnknownAuthor: 'Desconhecido',
  appNewNote: 'Nova anotação',
  ...
  scGroupFile: 'Arquivo',
  scGroupWorkbook: 'Pasta de trabalho',
  scGroupSelection: 'Seleção',
  scOpen: 'Abrir…',
  scSave: 'Salvar',
  ...
  scUndo: 'Desfazer',
  scRedo: 'Refazer',
  scNextSheet: 'Próxima planilha',
  scPrevSheet: 'Planilha anterior',
  scFirstCell: 'Primeira célula (A1)',
  scLastUsedCell: 'Última célula usada',
  scRowStart: 'Início da linha',
  scSelectColumn: 'Selecionar coluna',
  scSelectRow: 'Selecionar linha',
  scHideRows: 'Ocultar linhas',
  ...
  appTextToColsTooManyRows:
    'Texto para Colunas suporta até {count} linhas — a seleção tem {rows}. Selecione um intervalo menor.',
