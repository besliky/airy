 ...
 * same policy as the shell (PERF-1700c, apps/shell/src/main/accessibility-policy.ts).
 *
 ...
 * the previous standalone behavior) made the renderer build and maintain the
 * AX tree even with no AT present: the tree update runs in the BeginMainFrame
 * commit (`LocalFrameView::RunAccessibilitySteps`) and it also enables
