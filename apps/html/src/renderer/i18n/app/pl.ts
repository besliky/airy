...
export const pl = {
  ...
  wordWrapTip: 'Zawijaj długie wiersze w edytorze źródła',
  scrollSync: 'Synchronizacja przewijania',
  scrollSyncTip: 'Przewijaj podgląd i źródło razem w widoku podzielonym',
  saving: 'Zapisywanie…',
  savedOk: 'Zapisano',
  unsaved: 'Niezapisane',
  autoSave: 'Autozapis',
