...
export const nl = {
  ...
  viewSplit: 'Gesplitst',
  viewSource: 'Bron',
  wordWrap: 'Regelafbreking',
  wordWrapTip: 'Lange regels afbreken in de broneditor',
  scrollSync: 'Scrollsynchronisatie',
  scrollSyncTip: 'Scroll voorbeeldweergave en bron samen in de gesplitste weergave',
  saving: 'Opslaan…',
  savedOk: 'Opgeslagen',
