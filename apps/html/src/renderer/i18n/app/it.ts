...
export const it = {
  ...
  wordWrapTip: 'Manda a capo le righe lunghe nell’editor sorgente',
  scrollSync: 'Scorrimento sincronizzato',
  scrollSyncTip: 'Scorri anteprima e sorgente insieme nella vista divisa',
  saving: 'Salvataggio…',
  savedOk: 'Salvato',
  unsaved: 'Non salvato',
