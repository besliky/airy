...
export const fr = {
  ...
  wordWrapTip: 'Replier les longues lignes dans l’éditeur source',
  scrollSync: 'Défilement synchronisé',
  scrollSyncTip: 'Fait défiler l’aperçu et la source ensemble en vue fractionnée',
