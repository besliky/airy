...
export const cs = {
  ...
  wordWrapTip: 'Zalamovat dlouhé řádky v editoru zdroje',
  scrollSync: 'Synchronizace posuvu',
  scrollSyncTip: 'Posouvat náhled a zdroj dohromady v rozděleném zobrazení',
  saving: 'Ukládání…',
  savedOk: 'Uloženo',
  unsaved: 'Neuloženo',
