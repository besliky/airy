...
export const ms = {
  ...
  viewSplit: 'Terbelah',
  viewSource: 'Sumber',
  wordWrap: 'Balut baris',
  wordWrapTip: 'Balut baris panjang dalam editor sumber',
  scrollSync: 'Segerak skrol',
  scrollSyncTip: 'Skrol pratonton dan sumber bersama dalam paparan belah',
  saving: 'Menyimpan…',
  savedOk: 'Disimpan',
