...
export const pt = {
  ...
  wordWrapTip: 'Quebrar linhas longas no editor de código',
  scrollSync: 'Rolagem sincronizada',
  scrollSyncTip: 'Rolar a pré-visualização e o código juntos na visão dividida',
  saving: 'Salvando…',
  savedOk: 'Salvo',
  unsaved: 'Não salvo',
