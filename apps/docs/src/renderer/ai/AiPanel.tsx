...
import { AgentLoop, composeSkills, type AgentImage } from '@airy-office/agent-core'
import { imageGenerationAvailable } from '@airy-office/ai-provider/browser'
...
import { AiComposer, AiScopeQuote, AiTypingIndicator, type AiScopeQuoteData } from '@airy-office/ui'
import { AiryMark } from '../components/icons'
...
/** File-type icons for attachment cards (app attachment icon set); exts the
