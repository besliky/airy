...
import { openPptx, savePptx, type TextElement } from '@airy-office/pptx-engine'
import { buildRenderSlide, EMU_PER_PX_96, type RenderSlide } from '@airy-office/pptx-render'
import {
  fillToKonva,
  glyphToDraw,
  presetToShapeKind,
