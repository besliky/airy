<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — la suite bureautique IA open source : Docs, Sheets, Slides, PDF, Markdown et HTML avec un panneau IA intégré" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>Site web</b></a> ·
  <a href="https://github.com/besliky/airy"><b>Communauté</b></a> ·
  <a href="../../PRIVACY.md"><b>Confidentialité</b></a>
</p>

Airy est une alternative gratuite et open source à Microsoft Office pour
...
- **Vos clés ou aucune.** Utilisez votre propre clé pour Claude, OpenAI, Gemini, DeepSeek,
...
**À télécharger :** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon et Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 et Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs affichant une page de rapport annuel à deux colonnes avec une image de couverture pleine largeur, un tableau de KPI ombré, un en-tête et un pied de page, à un zoom de 80 % avec le panneau IA réduit"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs : une présentation d'entreprise avec une image de bannière ; l'IA a resserré la section Overview et inséré une nouvelle section à puces, et le panneau propose une annulation en un clic"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets : l'IA a ajouté une feuille Summary avec le chiffre d'affaires par région et par catégorie à l'aide de formules SUMIF, ainsi qu'un graphique en colonnes, et indique 43 modifications appliquées avec un bouton Annuler"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets : interrogée sur la région ayant généré le plus de chiffre d'affaires au T2, l'IA répond Europe avec la répartition par catégorie et cite les cellules utilisées sous forme de liens, à côté de la feuille Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Time-lapse de Airy Slides générant le deck investisseurs Aurora Home : l'IA planifie la trame narrative dans le panneau, les diapositives apparaissent une à une sur le canevas, et le deck terminé se conclut sur la demande finale" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides : la diapositive de couverture d'un jeu de diapositives Aurora Home pour investisseurs généré par l'IA sur le canevas, avec le prompt original d'une ligne et le résumé de l'IA de ce qu'elle a construit dans le panneau"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides : la diapositive de clôture, designée, du même jeu de 11 diapositives, avec le bandeau de miniatures à gauche et le panneau IA résumant la trame narrative"></td>
</tr>
<tr>
<td><b>Une ligne en entrée</b> — « Créer un jeu de 10 diapositives pour un pitch investisseur pour Aurora Home… ». Airy planifie la trame narrative, recherche les chiffres, et rédige chaque diapositive directement sur le canevas sous forme d'un véritable `.pptx`.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF : le mode Modifier le texte délimite chaque bloc de texte de la page pour une modification sur place tandis que le panneau IA répond à une question sur le rapport avec des citations de page"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs affichant un document Word converti localement à partir du PDF de bilan trimestriel Helios, ouvert dans un second onglet à côté du PDF d'origine"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Time-lapse de Airy HTML relookant la page d'accueil Lumen : une seule requête Restyle dans le panneau transforme la page sombre Midnight Studio en version chaleureuse Solar Daybreak, tandis que chaque section et tout le contenu restent en place" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML : une page de destination générée pour une lampe de bureau solaire dans l'orientation sombre Midnight Studio, affichée dans l'aperçu en direct avec le panneau IA résumant la page qu'elle vient de construire"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML : un tableau de bord personnel généré pour un designer freelance dans un style lin chaleureux, avec un rail latéral gauche, une salutation en serif et quatre cartes de métriques"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML : un rapport de données sur le marché des véhicules électriques généré dans un style broadsheet, avec un bandeau de titre en serif, un chiffre principal de 17,3 millions et une ligne de statistiques"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown : un paragraphe sélectionné affiche une bulle Ask AI avec une instruction saisie et des puces de suggestion telles que Polish, Make more concise, Expand et Fix grammar, ainsi que des boutons Send now et Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown affichant un document de notes de lancement avec un tableau, un diagramme de flux Mermaid et une liste de tâches, avec les prompts de démarrage du panneau IA à gauche"></td>
</tr>
<tr>
...
- **Votre modèle, votre clé.** Apportez une clé pour Claude, OpenAI, Gemini, DeepSeek et d'autres, serveurs locaux et
...
**Apportez votre propre clé.** Toutes les fonctions IA tournent sur des fournisseurs que vous configurez vous-même — détails ci-dessous.
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Dernier `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)            |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Dernier `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)              |
| **Windows** (x64, la plupart des PC) | Windows 10+, Intel/AMD                                | [Dernier installateur `-x64.exe`](https://github.com/besliky/airy/releases/latest)   |
| **Windows** sur Arm (ARM64)          | Windows 11 sur Arm (Snapdragon X et similaires)       | [Dernier installateur `-arm64.exe`](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 ou plus récent)     | [Dernier `.deb`](https://github.com/besliky/airy/releases/latest)                    |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Dernier `.rpm`](https://github.com/besliky/airy/releases/latest)                    |
| **Linux** — autres distributions     | x86_64, glibc 2.34+, FUSE 2                           | [Dernier `.AppImage`](https://github.com/besliky/airy/releases/latest)               |
...
```bash
sudo dnf install ./airy-<version>.x86_64.rpm     # Fedora / famille RHEL
...
sidecar xlsx (`cargo` dans le PATH) ; `npm run build -w @airy-office/sheets` le
...
Airy est en développement actif et vos retours contribuent à le
façonner.

- **Signalez un bug ou proposez une fonctionnalité** sur
  [GitHub Issues](https://github.com/besliky/airy/issues).
- **Rejoignez le salon de discussion Airy** sur
  [GenTeam](https://github.com/besliky/airy) pour échanger avec l'équipe et les
  autres utilisateurs.
- **Mettez une étoile au dépôt** si Airy vous est utile — c'est la
  meilleure façon de soutenir le projet.

## FAQ

<details>
<summary><b>Airy est-il gratuit ?</b></summary>

Oui. Airy est gratuit et open source sous licence Apache-2.0 — pas
d'essai, pas de palier payant pour les applications elles-mêmes.

</details>

<details>
<summary><b>Airy peut-il ouvrir des fichiers Microsoft Word, Excel et PowerPoint ?</b></summary>

Oui. Airy ouvre et enregistre des fichiers natifs `.docx`, `.xlsx` et
...
<details>
<summary><b>Airy fonctionne-t-il hors ligne ?</b></summary>
...
connexion réseau, avec votre propre clé
d'API de modèle.

</details>

<details>
<summary><b>Airy peut-il modifier des fichiers PDF ?</b></summary>
...
<details>
<summary><b>Airy peut-il convertir un PDF en Word, Excel ou PowerPoint ?</b></summary>
...
<details>
<summary><b>Airy peut-il convertir du HTML en Word ?</b></summary>
...
<details>
<summary><b>Airy collecte-t-il des données ?</b></summary>
...
[Airy Privacy](../../PRIVACY.md) pour la liste complète des événements
...
Airy ne serait pas possible sans ces projets open source :
...
Airy est distribué sous [licence Apache 2.0](../../LICENSE), avec une
