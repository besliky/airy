<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — 開源 AI 辦公套件：Docs、Sheets、Slides、PDF、Markdown 與 HTML，內建 AI 面板" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>官網</b></a> ·
  <a href="https://github.com/besliky/airy"><b>社群</b></a> ·
  <a href="../../PRIVACY.md"><b>隱私權</b></a>
</p>

Airy 是一套免費、開源的 Microsoft Office 替代方案，支援 macOS、
...
- **用你自己的金鑰，或完全不用。** 自行帶入 Claude、OpenAI、Gemini、DeepSeek、Kimi、GLM、Qwen、
  Doubao、MiniMax、Grok、Mistral、OpenRouter，或任何相容 OpenAI 介面
  的服務端點，也支援本機伺服器。

**立即取得：** [macOS](https://github.com/besliky/airy/releases/latest)（Apple Silicon 與 Intel）·
[Windows](https://github.com/besliky/airy/releases/latest)（x64 與 Arm）·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs 呈現一份雙欄年度報告頁面，含滿版封面圖片、灰底 KPI 表格、頁首與頁尾，縮放 80%，AI 面板收合"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs：一份含橫幅圖片的公司概覽；AI 精簡了概覽段落並插入新的條列區塊，面板提供一鍵回復"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets：AI 新增了一張摘要工作表，用 SUMIF 公式按地區與類別統計營收，並加上直條圖，回報套用了 43 項變更並提供復原按鈕"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets：詢問哪個地區在第二季營收領先，AI 回答歐洲並附上分類明細，同時將使用到的儲存格以連結形式引用，旁邊是訂單工作表"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Airy Slides 產生 Aurora Home 投資人簡報的縮時過程：AI 在面板中規劃故事線，投影片依序出現在畫布上，最終簡報以收尾的訴求結束" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides：畫面上是 AI 生成的 Aurora Home 投資人簡報封面投影片，附原始的一行提示詞與 AI 在面板中對已完成內容的摘要"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides：同一份 11 頁投影片的收尾頁設計完成，左側是縮圖列，AI 面板總結了整份簡報的敘事脈絡"></td>
</tr>
<tr>
<td><b>只需一句話</b>——「為 Aurora Home 製作一份 10 頁的投資人簡報……」。
Airy 會規劃敘事脈絡、研究相關數據，並把每一頁直接生成在畫面上，
成為一份真正的 `.pptx`。</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF：編輯文字模式為頁面上每個文字區塊畫出框線以供就地編輯，同時 AI 面板正在回答一則關於報告的問題並附上頁碼引用"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs 顯示由 Helios 季度報告 PDF 在本機轉換而成的 Word 文件，於第二個分頁開啟，旁邊是原始 PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Airy HTML 重新設計 Lumen 到達頁面的縮時過程：面板中一次 Restyle 請求就把深色的 Midnight Studio 頁面變成暖色的 Solar Daybreak 版本，而每個區塊與所有文案都維持不變" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML：以深色 Midnight Studio 風格方向生成的太陽能桌燈登陸頁，畫面顯示即時預覽，AI 面板總結了剛完成的頁面"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML：為自由接案設計師生成的個人儀表板介面，採溫暖亞麻風格，含左側導覽列、襯線問候語與四張指標卡片"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML：以報紙版式生成的電動車市場數據報告，含襯線報頭、一項 1730 萬的頭條數字與一列統計數據"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown：選取一段文字後出現 Ask AI 彈出視窗，內含輸入的指令與建議選項，如「潤飾」「更精簡」「擴寫」「修正語法」，並附「立即送出」與「加入佇列」按鈕"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown 呈現一份上線公告文件，內含表格、Mermaid 流程圖與待辦清單，左側是 AI 面板的起手提示詞"></td>
</tr>
<tr>
...
- **自帶模型，自帶金鑰。** 帶上 Claude、OpenAI、Gemini、
...
**自帶金鑰。** 所有 AI 功能都執行在你自行設定的服務商上——詳情見下文。
...
| 平台                                 | 系統需求                                               | 下載                                                                            |
| ------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon（arm64）   | macOS 11 以上                                          | [最新版 `.dmg`（arm64）](https://github.com/besliky/airy/releases/latest)       |
| **macOS** — Intel（x64）             | macOS 11 以上                                          | [最新版 `.dmg`（x64）](https://github.com/besliky/airy/releases/latest)         |
| **Windows**（x64，一般 PC）          | Windows 10 以上，Intel/AMD                             | [最新版 `-x64.exe` 安裝程式](https://github.com/besliky/airy/releases/latest)   |
| **Windows** on Arm（ARM64）          | Windows 11 on Arm（Snapdragon X 及同類機型）           | [最新版 `-arm64.exe` 安裝程式](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64，glibc 2.34+（Ubuntu 22.04 或以上）             | [最新版 `.deb`](https://github.com/besliky/airy/releases/latest)                |
| **Linux** — Fedora / RHEL / openSUSE | x86_64，glibc 2.34+（Fedora 35+、RHEL 9+、Leap 15.6+） | [最新版 `.rpm`](https://github.com/besliky/airy/releases/latest)                |
| **Linux** — 其他發行版               | x86_64，glibc 2.34+，FUSE 2                            | [最新版 `.AppImage`](https://github.com/besliky/airy/releases/latest)           |

所有版本皆由 `main` 分支建置，macOS 與 Windows 安裝程式皆有簽署。
較舊版本可在[發行頁面](https://github.com/besliky/airy/releases)找到。

<details>
<summary><b>在 Linux 上安裝</b></summary>

deb 套件可用 apt 安裝——會自動處理相依套件，並將 Airy 加入
應用程式選單：
...
```bash
sudo dnf install ./airy-<version>.x86_64.rpm     # Fedora / RHEL 家族
...
（`cargo` 需在 PATH 中）；執行 `npm run build -w @airy-office/sheets`
會自動完成編譯。每次變更需要通過哪些檢查、PR 如何合併，詳見
[CONTRIBUTING.md](../../CONTRIBUTING.md)。

## 社群

Airy 正在積極開發中，你的意見回饋會影響它的方向。

- 在 [GitHub Issues](https://github.com/besliky/airy/issues)
  **回報問題或提出功能需求**。
- 到 [GenTeam](https://github.com/besliky/airy) **加入 Airy 群組聊天**，
  和團隊及其他使用者交流。
- 如果 Airy 對你有幫助，**幫這個專案按個星星**——這是支持這個
  專案最簡單的方式。

## 常見問題

<details>
<summary><b>Airy 是免費的嗎？</b></summary>

是的。Airy 以 Apache-2.0 授權免費開源——應用程式本身沒有試用期，
也沒有付費方案。

</details>

<details>
<summary><b>Airy 能開啟 Microsoft Word、Excel 與 PowerPoint 檔案嗎？</b></summary>

可以。Airy 能開啟並儲存原生的 `.docx`、`.xlsx` 與 `.pptx` 檔案。
...
<details>
<summary><b>Airy 能離線使用嗎？</b></summary>
...
<details>
<summary><b>Airy 能編輯 PDF 檔案嗎？</b></summary>
...
<details>
<summary><b>Airy 能把 PDF 轉換成 Word、Excel 或 PowerPoint 嗎？</b></summary>
...
<details>
<summary><b>Airy 能把 HTML 轉換成 Word 嗎？</b></summary>
...
Airy 採用 [Apache License 2.0](../../LICENSE) 授權，唯一例外是
`ee/` 目錄，該目錄保留給未來的企業模組，適用
[Airy 企業授權](../../ee/LICENSE)。
