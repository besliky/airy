<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — open-source AI kancelářský balík: Docs, Sheets, Slides, PDF, Markdown a HTML s vestavěným AI panelem" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/besliky/airy" alt="Licence: Apache-2.0"></a>
  <a href="https://github.com/besliky/airy/releases/latest"><img src="https://img.shields.io/github/v/release/besliky/airy" alt="Nejnovější verze"></a>
  <a href="https://github.com/besliky/airy/releases"><img src="https://img.shields.io/github/downloads/besliky/airy/total" alt="Stažení"></a>
  <a href="https://github.com/besliky/airy/stargazers"><img src="https://img.shields.io/github/stars/besliky/airy?style=flat" alt="Hvězdy na GitHubu"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>Web</b></a> ·
  <a href="https://github.com/besliky/airy"><b>Komunita</b></a> ·
  <a href="../../PRIVACY.md"><b>Soukromí</b></a>
</p>

Airy je bezplatná open-source alternativa k Microsoft Office pro macOS,
...
- **Vaše klíče, nebo žádné.** Vložte použijte vlastní klíč pro Claude, OpenAI, Gemini, DeepSeek, Kimi, GLM,
  Qwen, Doubao, MiniMax, Grok, Mistral, OpenRouter nebo jakýkoli OpenAI
  kompatibilní endpoint, včetně lokálních serverů.

**Stáhnout:** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon a Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 a Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs vykresluje dvoukolonovou stránku výroční zprávy s celostránkovým titulním obrázkem, podbarvenou tabulkou KPI, záhlavím a zápatím, při 80% přiblížení se sbaleným AI panelem"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs: přehled společnosti s bannerovým obrázkem; AI zestručnila sekci Overview a vložila novou sekci s odrážkami, panel nabízí vrácení jedním kliknutím"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets: AI přidala list Summary s tržbami podle regionu a kategorie pomocí vzorců SUMIF, plus sloupcový graf, a hlásí 43 provedených změn s tlačítkem Zpět"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets: na dotaz, který region vedl v tržbách za Q2, AI odpovídá Evropa s rozpadem podle kategorií a jako odkazy cituje buňky, které použila, vedle listu Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Časosběrný záznam Airy Slides generujícího investorskou prezentaci Aurora Home: AI plánuje osnovu v panelu, snímky se postupně objevují na plátně a hotová prezentace končí závěrečnou výzvou k akci" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides: titulní snímek AI vygenerované investorské prezentace Aurora Home na ploše, s původním jednořádkovým promptem a shrnutím AI o tom, co vytvořila, v panelu"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides: navržený závěrečný snímek téže 11snímkové prezentace, s pruhem miniatur vlevo a AI panelem shrnujícím dějovou linku"></td>
</tr>
<tr>
<td><b>Jeden vstupní řádek</b> — „Vytvoř 10snímkovou investorskou prezentaci pro Aurora Home…“. Airy naplánuje dějovou linku, vyhledá čísla a vytvoří každý snímek na ploše jako skutečný soubor `.pptx`.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF: režim Upravit text obtahuje na stránce každý textový blok pro úpravu na místě, zatímco AI panel odpovídá na dotaz ke zprávě s citacemi stránek"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs zobrazuje dokument Word lokálně převedený z čtvrtletní zprávy Helios v PDF, otevřený na druhé záložce vedle původního PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Časosběrný záznam Airy HTML měnícího styl vstupní stránky Lumen: jeden požadavek Restyle v panelu změní temnou stránku Midnight Studio na teplou verzi Solar Daybreak, zatímco všechny sekce a veškerý obsah zůstávají na místě" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML: vygenerovaná vstupní stránka pro solární stolní lampu ve tmavém stylu Midnight Studio, zobrazená v živém náhledu s AI panelem shrnujícím právě vytvořenou stránku"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML: vygenerované rozhraní osobního dashboardu pro nezávislého designéra ve stylu teplého lnu, s levým panelem, patkovým pozdravem a čtyřmi metrickými kartami"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML: vygenerovaná datová zpráva o trhu elektromobilů ve stylu novinového listu, s patkovou hlavičkou, hlavním údajem 17,3 milionu a řádkem statistik"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown: vybraný odstavec zobrazuje vyskakovací okno Ask AI se zadanou instrukcí a návrhovými čipy jako Vylepšit, Zestručnit, Rozšířit a Opravit gramatiku, plus tlačítka Odeslat hned a Přidat do fronty"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown vykresluje dokument s poznámkami k vydání obsahující tabulku, vývojový diagram Mermaid a seznam úkolů, s úvodními prompty AI panelu vlevo"></td>
</tr>
<tr>
...
- **Vlastní model, vlastní klíč.** Použijte
...
**Vložte vlastní klíč.** Veškeré AI funkce běží na poskytovatelích, které si sami nakonfigurujete — podrobnosti níže.
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Nejnovější `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)          |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Nejnovější `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)            |
| **Windows** (x64, většina PC)        | Windows 10+, Intel/AMD                                | [Nejnovější instalátor `-x64.exe`](https://github.com/besliky/airy/releases/latest)   |
| **Windows** na Arm (ARM64)           | Windows 11 na Arm (Snapdragon X a podobné)            | [Nejnovější instalátor `-arm64.exe`](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 nebo novější)       | [Nejnovější `.deb`](https://github.com/besliky/airy/releases/latest)                  |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Nejnovější `.rpm`](https://github.com/besliky/airy/releases/latest)                  |
| **Linux** — ostatní distribuce       | x86_64, glibc 2.34+, FUSE 2                           | [Nejnovější `.AppImage`](https://github.com/besliky/airy/releases/latest)             |

Všechny sestavení pocházejí z `main`; instalátory pro macOS a Windows jsou
podepsané. Starší verze jsou na stránce [Releases](https://github.com/besliky/airy/releases).

<details>
<summary><b>Instalace na Linuxu</b></summary>

Balíček deb se instaluje pomocí apt — stáhne závislosti a přidá Airy
do nabídky aplikací:
...
(`cargo` na PATH); `npm run build -w @airy-office/sheets` jej zkompiluje
...
Airy je v aktivním vývoji a vaše zpětná vazba jej utváří.

- **Nahlaste chybu nebo navrhněte funkci** v
  [GitHub Issues](https://github.com/besliky/airy/issues).
- **Připojte se ke skupinovému chatu Airy** na
  [GenTeam](https://github.com/besliky/airy), kde si můžete promluvit s týmem
  i ostatními uživateli.
- **Ohvězdičkujte repozitář**, pokud je pro vás Airy užitečný — je to
  nejlepší způsob, jak projekt podpořit.

## Často kladené otázky

<details>
<summary><b>Je Airy zdarma?</b></summary>

Ano. Airy je bezplatný a open-source pod licencí Apache-2.0 — žádná
zkušební verze, žádný placený tarif pro samotné aplikace.

</details>

<details>
<summary><b>Umí Airy otevírat soubory Microsoft Word, Excel a PowerPoint?</b></summary>

Ano. Airy otevírá a ukládá nativní soubory `.docx`, `.xlsx` a `.pptx`.
...
<details>
<summary><b>Funguje Airy offline?</b></summary>
...
vlastním API klíčem k modelu.

</details>

<details>
<summary><b>Umí Airy upravovat soubory PDF?</b></summary>
...
<details>
<summary><b>Umí Airy převádět PDF do Wordu, Excelu nebo PowerPointu?</b></summary>
...
Ano. Airy podporuje vlastní klíč
...
<details>
<summary><b>Umí Airy převádět HTML do Wordu?</b></summary>
...
<details>
<summary><b>Sbírá Airy nějaká data?</b></summary>
...
v dokumentu [Airy Privacy](../../PRIVACY.md).
...
Airy by nebyl možný bez těchto open-source projektů:
...
Airy je licencován pod [Apache License 2.0](../../LICENSE), s jednou
