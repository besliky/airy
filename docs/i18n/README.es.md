<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy: la suite ofimática de IA de código abierto con Docs, Sheets, Slides, PDF, Markdown y HTML, con un panel de IA integrado" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/besliky/airy" alt="Licencia: Apache-2.0"></a>
  <a href="https://github.com/besliky/airy/releases/latest"><img src="https://img.shields.io/github/v/release/besliky/airy" alt="Última versión"></a>
  <a href="https://github.com/besliky/airy/releases"><img src="https://img.shields.io/github/downloads/besliky/airy/total" alt="Descargas"></a>
  <a href="https://github.com/besliky/airy/stargazers"><img src="https://img.shields.io/github/stars/besliky/airy?style=flat" alt="Estrellas de GitHub"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>Sitio web</b></a> ·
  <a href="https://github.com/besliky/airy"><b>Comunidad</b></a> ·
  <a href="../../PRIVACY.md"><b>Privacidad</b></a>
</p>

Airy es una alternativa gratuita y de código abierto a Microsoft Office
...
- **Tus claves o ninguna.** Usa tu propia clave para Claude, OpenAI, Gemini, DeepSeek, Kimi,
  GLM, Qwen, Doubao, MiniMax, Grok, Mistral, OpenRouter, o cualquier endpoint
  compatible con OpenAI, servidores locales incluidos.

**Consíguelo:** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon e Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 y Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs mostrando una página de informe anual a dos columnas con una imagen de portada a todo lo ancho, una tabla de KPI con sombreado, encabezado y pie de página, con un zoom del 80% y el panel de IA contraído"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs: una descripción general de la empresa con una imagen de banner; la IA ajustó la sección Overview e insertó una nueva sección con viñetas, y el panel ofrece deshacer el cambio con un solo clic"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets: la IA añadió una hoja Summary con ingresos por región y categoría usando fórmulas SUMIF, además de un gráfico de columnas, e informa de 43 cambios aplicados con un botón para deshacer"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets: al preguntar qué región lideró los ingresos del segundo trimestre, la IA responde Europa con el desglose por categoría y cita las celdas que usó como enlaces, junto a la hoja Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Time-lapse de Airy Slides generando el deck para inversores de Aurora Home: la IA planifica la narrativa en el panel, las diapositivas aparecen una tras otra en el lienzo, y el deck terminado concluye con la propuesta final" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides: la diapositiva de portada de una presentación para inversores de Aurora Home generada por IA en el lienzo, con la instrucción original de una línea y el resumen de la IA de lo que construyó en el panel"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides: la diapositiva de cierre diseñada de la misma presentación de 11 diapositivas, con la tira de miniaturas a la izquierda y el panel de IA resumiendo el hilo narrativo"></td>
</tr>
<tr>
<td><b>Con una sola línea</b> — «Crea una presentación de 10 diapositivas para inversores de Aurora Home…». Airy planifica el hilo narrativo, investiga las cifras y redacta cada diapositiva en el lienzo como un auténtico <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF: el modo Editar texto resalta el contorno de cada bloque de texto de la página para editarlo directamente, mientras el panel de IA responde una pregunta sobre el informe con citas de página"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs mostrando un documento de Word convertido localmente a partir del PDF de la revisión trimestral de Helios, abierto en una segunda pestaña junto al PDF original"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Time-lapse de Airy HTML rediseñando la landing page de Lumen: una sola solicitud de Restyle en el panel convierte la página oscura de Midnight Studio en la cálida versión Solar Daybreak, mientras cada sección y todo el contenido permanecen intactos" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML: una landing page generada para una lámpara de escritorio solar en la dirección de estilo oscuro Midnight Studio, mostrada en la vista previa en vivo con el panel de IA resumiendo la página que acaba de construir"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML: una interfaz de panel personal generada para una diseñadora freelance en un estilo lino cálido, con una barra lateral izquierda, un saludo en tipografía serif y cuatro tarjetas de métricas"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML: un informe de datos generado sobre el mercado de vehículos eléctricos en estilo periódico (broadsheet), con una cabecera serif, una cifra destacada de 17,3 millones y una fila de estadísticas"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown: un párrafo seleccionado muestra un popover de Ask AI con una instrucción escrita y chips de sugerencia como Polish, Make more concise, Expand y Fix grammar, además de los botones Send now y Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown mostrando un documento de notas de lanzamiento con una tabla, un diagrama de flujo de Mermaid y una lista de tareas, con las sugerencias iniciales del panel de IA a la izquierda"></td>
</tr>
<tr>
...
- **Una IA que edita el propio documento.** Cambios con seguimiento en Docs,
  ...
  volver.
- **Tu modelo, tu clave.** Usa tu propia clave para Claude, OpenAI, Gemini, DeepSeek y más; también incluye servidores
...
**Usa tu propia clave.** Todas las funciones de IA funcionan con proveedores que tú configuras; los detalles, abajo.
...
| --------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)       | macOS 11+                                             | [Última versión `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)        |
| **macOS** — Intel (x64)                 | macOS 11+                                             | [Última versión `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)          |
| **Windows** (x64, la mayoría de los PC) | Windows 10+, Intel/AMD                                | [Instalador `-x64.exe` más reciente](https://github.com/besliky/airy/releases/latest)   |
| **Windows** en Arm (ARM64)              | Windows 11 en Arm (Snapdragon X y similares)          | [Instalador `-arm64.exe` más reciente](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu             | x86_64, glibc 2.34+ (Ubuntu 22.04 o posterior)        | [Última versión `.deb`](https://github.com/besliky/airy/releases/latest)                |
| **Linux** — Fedora / RHEL / openSUSE    | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Última versión `.rpm`](https://github.com/besliky/airy/releases/latest)                |
| **Linux** — otras distribuciones        | x86_64, glibc 2.34+, FUSE 2                           | [Última versión `.AppImage`](https://github.com/besliky/airy/releases/latest)           |
...
xlsx (`cargo` en el PATH); `npm run build -w @airy-office/sheets` lo compila
...
Airy está en desarrollo activo y tu opinión ayuda a darle forma.

- **Reporta un error o solicita una función** en
  [GitHub Issues](https://github.com/besliky/airy/issues).
- **Únete al chat de grupo de Airy** en
  [GenTeam](https://github.com/besliky/airy) para hablar con el equipo y otros
  usuarios.
- **Dale una estrella al repositorio** si Airy te resulta útil: es la
  mejor forma de apoyar el proyecto.

## Preguntas frecuentes

<details>
<summary><b>¿Es Airy gratuito?</b></summary>

Sí. Airy es gratuito y de código abierto bajo la licencia Apache-2.0:
sin prueba gratuita, sin nivel de pago para las apps en sí.

</details>

<details>
<summary><b>¿Puede Airy abrir archivos de Microsoft Word, Excel y PowerPoint?</b></summary>

Sí. Airy abre y guarda archivos nativos `.docx`, `.xlsx` y `.pptx`. Al
...
<details>
<summary><b>¿Funciona Airy sin conexión?</b></summary>
...
red, con tu propia clave de API de modelo.

</details>

<details>
<summary><b>¿Puede Airy editar archivos PDF?</b></summary>
...
<details>
<summary><b>¿Puede Airy convertir PDF a Word, Excel o PowerPoint?</b></summary>
...
<details>
<summary><b>¿Puede Airy convertir HTML a Word?</b></summary>
...
<details>
<summary><b>¿Airy recopila algún dato?</b></summary>
...
de correo electrónico. Consulta [Airy Privacy](../../PRIVACY.md) para
...
Airy no sería posible sin estos proyectos de código abierto:
...
Airy tiene licencia [Apache License 2.0](../../LICENSE), con una
