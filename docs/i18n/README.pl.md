<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — otwarty pakiet biurowy AI: Docs, Sheets, Slides, PDF, Markdown i HTML z wbudowanym panelem AI" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/besliky/airy" alt="Licencja: Apache-2.0"></a>
  <a href="https://github.com/besliky/airy/releases/latest"><img src="https://img.shields.io/github/v/release/besliky/airy" alt="Najnowsze wydanie"></a>
  <a href="https://github.com/besliky/airy/releases"><img src="https://img.shields.io/github/downloads/besliky/airy/total" alt="Liczba pobrań"></a>
  <a href="https://github.com/besliky/airy/stargazers"><img src="https://img.shields.io/github/stars/besliky/airy?style=flat" alt="Gwiazdki na GitHubie"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>Strona internetowa</b></a> ·
  <a href="https://github.com/besliky/airy"><b>Społeczność</b></a> ·
  <a href="../../PRIVACY.md"><b>Prywatność</b></a>
</p>

Airy to darmowa, otwarta alternatywa dla Microsoft Office na macOS,
...
- **Lokalność jako zasada projektowa.** Pliki są otwierane, edytowane,
  ...
  wybierzesz.
- **Twoje klucze albo żadne.** Użyj własnego klucza dla Claude, OpenAI, Gemini, DeepSeek, Kimi, GLM, Qwen,
  Doubao, MiniMax, Grok, Mistral, OpenRouter lub dowolnego endpointu
  zgodnego z OpenAI, w tym lokalnych serwerów.

**Pobierz:** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon i Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 i Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs renderuje dwukolumnową stronę raportu rocznego z pełnowymiarowym zdjęciem na okładce, zacienioną tabelą KPI, nagłówkiem i stopką, przy powiększeniu 80% ze zwiniętym panelem AI"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs: przegląd firmy z obrazem w formie banera; AI skróciła sekcję Overview i wstawiła nową sekcję z punktami, a panel proponuje jednokrotne przywrócenie"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets: AI dodała arkusz Summary z przychodami według regionu i kategorii przy użyciu formuł SUMIF, plus wykres kolumnowy, i zgłasza 43 zastosowane zmiany z przyciskiem Undo"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets: na pytanie, który region przewodził w przychodach za Q2, AI odpowiada Europa z podziałem na kategorie i podaje jako klikalne odnośniki komórki, z których skorzystała, obok arkusza Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Timelapse Airy Slides generującego prezentację inwestorską Aurora Home: AI planuje fabułę w panelu, slajdy pojawiają się na płótnie jeden po drugim, a gotowa prezentacja kończy się finałowym wezwaniem do działania" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides: slajd tytułowy wygenerowanej przez AI prezentacji inwestorskiej Aurora Home na płótnie, z oryginalnym jednowierszowym promptem i podsumowaniem AI tego, co zbudowała, w panelu"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides: zaprojektowany slajd końcowy tej samej 11-slajdowej prezentacji, z paskiem miniatur po lewej i panelem AI podsumowującym fabułę"></td>
</tr>
<tr>
<td><b>Jedna linijka na wejściu</b> — „Stwórz 10-slajdową prezentację inwestorską dla Aurora Home…”. Airy planuje fabułę, sprawdza dane liczbowe i tworzy każdy slajd na płótnie jako prawdziwy plik `.pptx`.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF: tryb Edit text zaznacza każdy blok tekstu na stronie do edycji w miejscu, a panel AI odpowiada na pytanie o raport z cytowaniem stron"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs wyświetla dokument Word przekonwertowany lokalnie z kwartalnego raportu Helios w formacie PDF, otwarty w drugiej karcie obok oryginalnego PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Timelapse Airy HTML zmieniającego styl strony docelowej Lumen: jedno żądanie Restyle w panelu zmienia ciemną stronę Midnight Studio w ciepłą wersję Solar Daybreak, podczas gdy każda sekcja i cała treść pozostają na miejscu" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML: wygenerowana strona docelowa dla solarnej lampki biurkowej w ciemnym kierunku Midnight Studio, wyświetlana w podglądzie na żywo z panelem AI podsumowującym właśnie zbudowaną stronę"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML: wygenerowany interfejs osobistego panelu dla projektanta freelancera w ciepłym, lnianym stylu, z lewym panelem bocznym, szeryfowym powitaniem i czterema kartami metryk"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML: wygenerowany raport danych o rynku pojazdów elektrycznych w stylu gazetowym, z szeryfową winietą tytułową, nagłówkową liczbą 17,3 miliona i wierszem statystyk"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown: zaznaczony akapit pokazuje wyskakujące okno Ask AI z wpisaną instrukcją i chipami z podpowiedziami, takimi jak Polish, Make more concise, Expand i Fix grammar, a także przyciskami Send now i Add to queue"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown renderuje dokument z notatkami o wydaniu z tabelą, diagramem przepływu Mermaid i listą zadań, z podpowiedziami startowymi panelu AI po lewej stronie"></td>
</tr>
<tr>
...
- **Twój model, Twój klucz.** Użyj własnego klucza do Claude, OpenAI, Gemini, DeepSeek i innych, z lokalnymi serwerami i
...
**Przynieś własny klucz.** Wszystkie funkcje AI działają na dostawcach, których sam konfigurujesz — szczegóły poniżej.
...
| --------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **macOS** — Apple Silicon (arm64)       | macOS 11+                                             | [Najnowszy plik `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)     |
| **macOS** — Intel (x64)                 | macOS 11+                                             | [Najnowszy plik `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)       |
| **Windows** (x64, większość komputerów) | Windows 10+, Intel/AMD                                | [Najnowszy instalator `-x64.exe`](https://github.com/besliky/airy/releases/latest)   |
| **Windows** na Arm (ARM64)              | Windows 11 na Arm (Snapdragon X i podobne)            | [Najnowszy instalator `-arm64.exe`](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu             | x86_64, glibc 2.34+ (Ubuntu 22.04 lub nowszy)         | [Najnowszy plik `.deb`](https://github.com/besliky/airy/releases/latest)             |
| **Linux** — Fedora / RHEL / openSUSE    | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Najnowszy plik `.rpm`](https://github.com/besliky/airy/releases/latest)             |
| **Linux** — inne dystrybucje            | x86_64, glibc 2.34+, FUSE 2                           | [Najnowszy plik `.AppImage`](https://github.com/besliky/airy/releases/latest)        |
...
Plik deb instaluje się przez apt — ściąga zależności i dodaje Airy do
menu aplikacji:
...
```bash
sudo dnf install ./airy-<version>.x86_64.rpm     # Fedora / rodzina RHEL
...
sidecara xlsx (`cargo` w PATH); `npm run build -w @airy-office/sheets`
...
Airy jest w aktywnym rozwoju, a Twoja opinia go kształtuje.

- **Zgłoś błąd lub poproś o funkcję** w
  [GitHub Issues](https://github.com/besliky/airy/issues).
- **Przyłącz się do czatu grupowego Airy** na
  [GenTeam](https://github.com/besliky/airy), aby rozmawiać z zespołem i innymi
  użytkownikami.
- **Oznacz repozytorium gwiazdką**, jeśli Airy jest dla Ciebie
  przydatne — to najlepszy sposób wsparcia projektu.

## FAQ

<details>
<summary><b>Czy Airy jest darmowe?</b></summary>

Tak. Airy jest darmowe i otwarte na licencji Apache-2.0 — bez okresu
próbnego, bez płatnego poziomu dla samych aplikacji.

</details>

<details>
<summary><b>Czy Airy może otwierać pliki Microsoft Word, Excel i PowerPoint?</b></summary>

Tak. Airy otwiera i zapisuje natywne pliki `.docx`, `.xlsx` i `.pptx`.
...
<details>
<summary><b>Czy Airy działa offline?</b></summary>
...
sieciowego, z własnym kluczem API
modelu.

</details>

<details>
<summary><b>Czy Airy może edytować pliki PDF?</b></summary>
...
<details>
<summary><b>Czy Airy może konwertować PDF do Word, Excel lub PowerPoint?</b></summary>
...
<details>
<summary><b>Czy Airy może konwertować HTML do Worda?</b></summary>
...
<details>
<summary><b>Czy Airy zbiera jakieś dane?</b></summary>
...
[Airy Privacy](../../PRIVACY.md), aby poznać pełny wykaz zdarzeń i
ujawnianych danych.
...
Airy nie byłoby możliwe bez tych projektów open source:
...
Airy jest licencjonowane na warunkach [Apache License 2.0](../../LICENSE), z
