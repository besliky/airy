<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — ओपन-सोर्स AI ऑफ़िस सूट: बिल्ट-इन AI पैनल के साथ Docs, Sheets, Slides, PDF, Markdown और HTML" width="100%">
    </picture>
  </a>
</p>
...
- **आपकी कीज़ या कोई कीज़ नहीं।** अपनी खुद की key लाएँ Claude, OpenAI, Gemini, DeepSeek, Kimi, GLM, Qwen, Doubao, MiniMax, Grok, Mistral, OpenRouter या किसी भी OpenAI-compatible endpoint के लिए अपनी खुद की key लाएँ — लोकल सर्वर भी शामिल हैं।

**पाएँ:** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon और Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 और Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs में 80% ज़ूम पर एक टू-कॉलम एन्युअल-रिपोर्ट पेज दिखाया गया है, जिसमें फ़ुल-विड्थ कवर इमेज, शेडेड KPI टेबल, हेडर और फ़ुटर हैं, और AI पैनल संकुचित (collapsed) है"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs: बैनर इमेज के साथ एक कंपनी ओवरव्यू; AI ने ओवरव्यू को संक्षिप्त किया और एक नया बुलेटेड सेक्शन जोड़ा, और पैनल एक-क्लिक रोलबैक का विकल्प देता है"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets: AI ने SUMIF फ़ॉर्मूला इस्तेमाल करके रीजन और कैटेगरी के हिसाब से रेवेन्यू के साथ एक Summary शीट जोड़ी, साथ ही एक कॉलम चार्ट, और Undo बटन के साथ 43 लागू किए गए बदलावों की रिपोर्ट दी"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets: यह पूछने पर कि Q2 रेवेन्यू में कौन सा रीजन आगे रहा, AI Orders शीट के बगल में कैटेगरी ब्रेकडाउन के साथ Europe का जवाब देता है और जिन सेल्स का इस्तेमाल किया, उन्हें लिंक के रूप में साइट करता है"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Airy Slides द्वारा Aurora Home इन्वेस्टर डेक बनाने का टाइम-लैप्स: AI पैनल में कहानी की रूपरेखा तय करता है, स्लाइड्स एक के बाद एक कैनवस पर दिखती हैं, और तैयार डेक closing ask पर खत्म होता है" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides: कैनवस पर AI-जनरेटेड Aurora Home इन्वेस्टर डेक की कवर स्लाइड, साथ में मूल एक-लाइन प्रॉम्प्ट और पैनल में AI का यह सारांश कि उसने क्या बनाया"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides: उसी 11-स्लाइड डेक की डिज़ाइन की गई क्लोज़िंग स्लाइड, बाईं ओर थंबनेल स्ट्रिप और स्टोरीलाइन का सारांश देता AI पैनल"></td>
</tr>
<tr>
<td><b>एक लाइन डालें</b> — "Aurora Home के लिए 10-स्लाइड का इन्वेस्टर पिच डेक बनाएँ…"। Airy स्टोरीलाइन प्लान करता है, नंबरों पर रिसर्च करता है, और हर स्लाइड को असली <code>.pptx</code> के रूप में कैनवस पर तैयार करता है।</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF: Edit text मोड इन-प्लेस एडिटिंग के लिए पेज के हर टेक्स्ट ब्लॉक की आउटलाइन दिखाता है, जबकि AI पैनल पेज साइटेशन के साथ रिपोर्ट से जुड़े सवाल का जवाब देता है"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs में Helios क्वार्टरली रिव्यू PDF से लोकल रूप से कन्वर्ट किया गया Word डॉक्यूमेंट दिख रहा है, जो मूल PDF के बगल में दूसरे टैब में खुला है"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Airy HTML द्वारा Lumen लैंडिंग पेज को दोबारा स्टाइल करने का टाइम-लैप्स: पैनल में एक Restyle रिक्वेस्ट डार्क Midnight Studio पेज को गर्म Solar Daybreak वर्शन में बदल देती है, जबकि हर सेक्शन और सारा कॉन्टेंट अपनी जगह पर बना रहता है" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML: डार्क Midnight Studio डायरेक्शन में एक सोलर डेस्क लैंप के लिए जनरेट किया गया लैंडिंग पेज, लाइव प्रीव्यू में दिखाया गया, साथ में AI पैनल जो अभी बनाए गए पेज का सारांश दे रहा है"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML: एक फ़्रीलांस डिज़ाइनर के लिए गर्म लिनन स्टाइल में जनरेट किया गया पर्सनल डैशबोर्ड UI, जिसमें एक लेफ़्ट रेल, सेरिफ़ ग्रीटिंग और चार मेट्रिक कार्ड हैं"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML: ब्रॉडशीट स्टाइल में जनरेट की गई EV-मार्केट डेटा रिपोर्ट, जिसमें एक सेरिफ़ मास्टहेड, 17.3 मिलियन की हेडलाइन फ़िगर और एक स्टैट रो है"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown: चुने गए पैराग्राफ़ पर एक Ask AI पॉपओवर दिखता है, जिसमें टाइप किया हुआ इंस्ट्रक्शन और Polish, Make more concise, Expand व Fix grammar जैसे सजेशन चिप्स हैं, साथ ही Send now और Add to queue बटन हैं"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown एक लॉन्च-नोट्स डॉक्यूमेंट रेंडर कर रहा है जिसमें एक टेबल, एक Mermaid फ़्लोचार्ट और एक टास्क लिस्ट है, और बाईं ओर AI पैनल के स्टार्टर प्रॉम्प्ट हैं"></td>
</tr>
<tr>
...
- **आपका मॉडल, आपकी key।** Claude, OpenAI, Gemini,
...
**अपनी key लाएँ।** सभी AI सुविधाएँ आपके द्वारा कॉन्फ़िगर किए गए प्रदाताओं पर चलती हैं — विवरण नीचे।
...
| ------------------------------------ | ----------------------------------------------------- | -------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [नवीनतम `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)         |
| **macOS** — Intel (x64)              | macOS 11+                                             | [नवीनतम `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)           |
| **Windows** (x64, ज़्यादातर PC)      | Windows 10+, Intel/AMD                                | [नवीनतम `-x64.exe` installer](https://github.com/besliky/airy/releases/latest)   |
| **Windows** Arm पर (ARM64)           | Windows 11 on Arm (Snapdragon X और समान)              | [नवीनतम `-arm64.exe` installer](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 या नया)             | [नवीनतम `.deb`](https://github.com/besliky/airy/releases/latest)                 |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [नवीनतम `.rpm`](https://github.com/besliky/airy/releases/latest)                 |
| **Linux** — अन्य डिस्ट्रीब्यूशन      | x86_64, glibc 2.34+, FUSE 2                           | [नवीनतम `.AppImage`](https://github.com/besliky/airy/releases/latest)            |

सभी बिल्ड `main` से बनते हैं; macOS और Windows इंस्टॉलर साइन किए हुए हैं।
पुराने वर्शन [Releases](https://github.com/besliky/airy/releases) पेज पर मौजूद हैं।

<details>
<summary><b>Linux पर इंस्टॉल करना</b></summary>

deb, apt के साथ इंस्टॉल होता है — यह डिपेंडेंसीज़ खींच लेता है और Airy को applications मेन्यू में जोड़ देता है:
...
(`cargo` PATH में होना चाहिए); `npm run build -w @airy-office/sheets` इसे
...
Airy पर सक्रिय रूप से काम चल रहा है, और आपका फ़ीडबैक इसे आकार देता है।

- [GitHub Issues](https://github.com/besliky/airy/issues) में
  **बग रिपोर्ट करें या फ़ीचर रिक्वेस्ट करें**।
- टीम और दूसरे यूज़र्स से बात करने के लिए
  [GenTeam](https://github.com/besliky/airy) पर **Airy ग्रुप चैट जॉइन करें**।
- अगर Airy आपके लिए उपयोगी है तो **रीपो को स्टार करें** — प्रोजेक्ट को
  सपोर्ट करने का यह सबसे अच्छा तरीका है।

## FAQ

<details>
<summary><b>क्या Airy फ़्री है?</b></summary>

हाँ। Airy, Apache-2.0 लाइसेंस के तहत फ़्री और ओपन-सोर्स है — कोई ट्रायल
नहीं, ऐप्स के लिए खुद कोई पेड टियर नहीं।

</details>

<details>
<summary><b>क्या Airy Microsoft Word, Excel और PowerPoint फ़ाइलें खोल सकता है?</b></summary>

हाँ। Airy नेटिव `.docx`, `.xlsx` और `.pptx` फ़ाइलें खोलता और सेव करता है।
...
<details>
<summary><b>क्या Airy ऑफ़लाइन काम करता है?</b></summary>
...
सर्च, इमेज टूल्स) को नेटवर्क कनेक्शन चाहिए, और उसके लिए आपकी अपनी मॉडल API key ज़रूरी है।

</details>

<details>
<summary><b>क्या Airy PDF फ़ाइलें एडिट कर सकता है?</b></summary>
...
<details>
<summary><b>क्या Airy PDF को Word, Excel या PowerPoint में कन्वर्ट कर सकता है?</b></summary>
...
<details>
<summary><b>क्या Airy HTML को Word में कन्वर्ट कर सकता है?</b></summary>
...
<details>
<summary><b>क्या Airy कोई डेटा कलेक्ट करता है?</b></summary>
...
इन ओपन-सोर्स प्रोजेक्ट्स के बिना Airy संभव नहीं होता:
...
Airy को [Apache License 2.0](../../LICENSE) के तहत लाइसेंस किया गया
