<p align="center">
  <a href="https://github.com/besliky/airy">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="Airy — 내장 AI 패널을 갖춘 오픈소스 AI 오피스 제품군: Docs, Sheets, Slides, PDF, Markdown, HTML" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/besliky/airy" alt="라이선스: Apache-2.0"></a>
  <a href="https://github.com/besliky/airy/releases/latest"><img src="https://img.shields.io/github/v/release/besliky/airy" alt="최신 릴리스"></a>
  <a href="https://github.com/besliky/airy/releases"><img src="https://img.shields.io/github/downloads/besliky/airy/total" alt="다운로드 수"></a>
  <a href="https://github.com/besliky/airy/stargazers"><img src="https://img.shields.io/github/stars/besliky/airy?style=flat" alt="GitHub 스타 수"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/besliky/airy"><b>웹사이트</b></a> ·
  <a href="https://github.com/besliky/airy"><b>커뮤니티</b></a> ·
  <a href="../../PRIVACY.md"><b>개인정보</b></a>
</p>

Airy는 macOS, Windows, Linux에서 사용할 수 있는 무료 오픈소스
...
**다운로드:** [macOS](https://github.com/besliky/airy/releases/latest) (Apple Silicon 및 Intel) ·
[Windows](https://github.com/besliky/airy/releases/latest) (x64 및 Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="Airy Docs가 전체 폭 표지 이미지, 음영 처리된 KPI 표, 머리글과 바닥글이 있는 2단 연차 보고서 페이지를 80% 확대 비율로 렌더링하고 있으며 AI 패널은 접혀 있는 화면"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="Airy Docs: 배너 이미지가 있는 회사 개요 문서에서 AI가 개요 섹션을 다듬고 새로운 글머리 기호 섹션을 삽입했으며, 패널에서 원클릭 롤백을 제공하는 화면"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="Airy Sheets: AI가 SUMIF 수식을 사용해 지역 및 카테고리별 매출이 담긴 Summary 시트와 세로 막대형 차트를 추가하고, 실행 취소 버튼과 함께 43건의 변경 사항이 적용되었다고 알려주는 화면"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="Airy Sheets: 2분기 매출을 어느 지역이 주도했는지 묻자 AI가 카테고리별 세부 내역과 함께 유럽이라고 답하고, 사용한 셀을 링크 형태의 출처로 인용하는 화면(Orders 시트 옆에 표시됨)"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Airy Slides가 Aurora Home 투자자용 덱을 생성하는 타임랩스: AI가 패널에서 스토리라인을 구상하고, 슬라이드가 캔버스에 차례로 나타나며, 완성된 덱은 마무리 제안으로 끝난다" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="Airy Slides: 캔버스에 표시된 AI 생성 Aurora Home 투자자 덱의 표지 슬라이드, 패널에는 원래 입력한 한 줄 프롬프트와 AI가 만든 내용에 대한 요약이 보이는 화면"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="Airy Slides: 같은 11장짜리 덱의 디자인이 완료된 마지막 슬라이드, 왼쪽에는 축소판 슬라이드 목록이, AI 패널에는 전체 스토리라인 요약이 표시된 화면"></td>
</tr>
<tr>
<td><b>한 줄만 입력하세요</b> — "Aurora Home을 위한 10장짜리 투자자 피치 덱을 만들어줘…"처럼요. Airy가 스토리라인을 구성하고, 필요한 숫자를 조사하고, 실제 <code>.pptx</code>로 모든 슬라이드를 캔버스에 초안 작성합니다.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="Airy PDF: 텍스트 편집 모드가 페이지의 모든 텍스트 블록을 표시해 바로 편집할 수 있게 하고, 동시에 AI 패널이 보고서에 대한 질문에 페이지 출처와 함께 답변하는 화면"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="Airy Docs가 Helios 분기 보고서 PDF에서 로컬로 변환된 Word 문서를, 원본 PDF 옆의 두 번째 탭에 열어 보여주는 화면"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Airy HTML이 Lumen 랜딩 페이지를 리스타일링하는 타임랩스: 패널에서의 한 번의 Restyle 요청으로 어두운 Midnight Studio 페이지가 따뜻한 Solar Daybreak 버전으로 바뀌지만, 모든 섹션과 문구는 그대로 유지된다" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="Airy HTML: 어두운 Midnight Studio 스타일로 생성된 태양광 스탠드 랜딩 페이지가 실시간 미리보기에 표시되고, AI 패널이 방금 만든 페이지를 요약해 보여주는 화면"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="Airy HTML: 프리랜서 디자이너를 위해 생성된 개인 대시보드 UI가 따뜻한 리넨 스타일로 표시되고, 왼쪽 레일, 세리프체 인사말, 네 개의 지표 카드가 있는 화면"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="Airy HTML: 신문 형식으로 생성된 전기차 시장 데이터 보고서, 세리프체 제호, 1,730만이라는 헤드라인 숫자, 통계 행이 표시된 화면"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="Airy Markdown: 선택한 문단에 Ask AI 팝오버가 나타나 입력한 지시문과 함께 다듬기, 더 간결하게, 확장하기, 문법 수정 같은 제안 칩, 그리고 지금 보내기와 대기열에 추가 버튼이 표시된 화면"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="Airy Markdown이 표, Mermaid 순서도, 할 일 목록이 포함된 출시 공지 문서를 렌더링하고, 왼쪽에는 AI 패널의 시작 프롬프트가 표시된 화면"></td>
</tr>
<tr>
...
- **문서를 직접 편집하는 AI.** Docs에서는 변경 내용 추적, Sheets에서는 실시간으로
  ...
  되돌릴 수 있는 스냅샷이 남습니다.
- **내 모델, 내 키.** 직접 Claude, OpenAI, Gemini, DeepSeek
...
**직접 키를 가져오세요.** 모든 AI 기능은 직접 구성한 공급자에서 동작합니다. 자세한 내용은 아래에 있습니다.
...
| 플랫폼                               | 요구 사항                                             | 다운로드                                                                       |
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------ |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [최신 `.dmg` (arm64)](https://github.com/besliky/airy/releases/latest)         |
| **macOS** — Intel (x64)              | macOS 11+                                             | [최신 `.dmg` (x64)](https://github.com/besliky/airy/releases/latest)           |
| **Windows** (x64, 대부분의 PC)       | Windows 10+, Intel/AMD                                | [최신 `-x64.exe` 설치 파일](https://github.com/besliky/airy/releases/latest)   |
| **Windows** on Arm (ARM64)           | Windows 11 on Arm (Snapdragon X 및 유사 기종)         | [최신 `-arm64.exe` 설치 파일](https://github.com/besliky/airy/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 이상)               | [최신 `.deb`](https://github.com/besliky/airy/releases/latest)                 |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [최신 `.rpm`](https://github.com/besliky/airy/releases/latest)                 |
| **Linux** — 기타 배포판              | x86_64, glibc 2.34+, FUSE 2                           | [최신 `.AppImage`](https://github.com/besliky/airy/releases/latest)            |

모든 빌드는 `main` 브랜치에서 만들어지며, macOS와 Windows 설치 파일에는
서명이 되어 있습니다. 이전 버전은 [릴리스](https://github.com/besliky/airy/releases) 페이지에서 확인할 수 있습니다.

<details>
<summary><b>Linux에 설치하기</b></summary>

deb 패키지는 apt로 설치합니다 — 필요한 의존성을 함께 설치하고 Airy를
애플리케이션 메뉴에 추가합니다:
...
Airy는 활발히 개발되고 있으며, 여러분의 피드백이 그 방향을
만들어갑니다.

- **버그를 신고하거나 기능을 요청**하려면
  [GitHub Issues](https://github.com/besliky/airy/issues)를 이용하세요.
- **Airy 그룹 채팅에 참여**하려면
  [GenTeam](https://github.com/besliky/airy)에서 팀 및 다른 사용자들과 대화할 수 있습니다.
- Airy가 유용하다고 느끼셨다면 **저장소에 스타를 눌러주세요** —
  프로젝트를 지원하는 가장 좋은 방법입니다.

## 자주 묻는 질문

<details>
<summary><b>Airy는 무료인가요?</b></summary>

네. Airy는 Apache-2.0 라이선스 아래 무료로 제공되는 오픈소스
소프트웨어입니다 — 체험판도 없고, 앱 자체에 유료 등급도 없습니다.

</details>

<details>
<summary><b>Airy에서 마이크로소프트 Word, Excel, PowerPoint 파일을 열 수 있나요?</b></summary>

네. Airy는 네이티브 `.docx`, `.xlsx`, `.pptx` 파일을 열고 저장할 수
...
<details>
<summary><b>Airy는 오프라인에서도 동작하나요?</b></summary>

문서 편집은 완전히 로컬에서 이루어집니다 — 파일을 열고, 편집하고,
저장하고, 변환하는 과정에서 파일이 기기를 벗어나지 않습니다. AI
기능(에이전트, 검색, 이미지 도구)은 네트워크 연결이 필요하며, 직접 발급받은 모델 API 키가 있어야 합니다.

</details>

<details>
<summary><b>Airy에서 PDF 파일을 편집할 수 있나요?</b></summary>
...
<details>
<summary><b>Airy에서 PDF를 Word, Excel, PowerPoint로 변환할 수 있나요?</b></summary>
...
<details>
<summary><b>Airy에서 HTML을 Word로 변환할 수 있나요?</b></summary>
...
Airy는 다음의 오픈소스 프로젝트가 없었다면 만들어질 수 없었습니다:
...
Airy는 [Apache License 2.0](../../LICENSE)에 따라 라이선스가
