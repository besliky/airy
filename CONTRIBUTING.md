...
AI features need a provider configured in Settings (your own API key); without
one they answer with a clear "configure a provider" message instead of failing
silently, and web search falls back to a keyless backend.
